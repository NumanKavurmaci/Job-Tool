...
async function continueExternalApplyFromLinkedIn(args: {
  ...
  try {
    ...
    const handoff: EasyApplyExternalApplicationHandoff = {
      ...
      retryable: externalResult.retryable,
      missingProfileData: externalResult.missingProfileData,
            ...
            ...(result.externalApplication
              ? {
                  externalApplication: {
                    ...
                    failureReasonCode: result.externalApplication.failureReasonCode ?? null,
                    retryable: result.externalApplication.retryable ?? null,
                    missingProfileData: result.externalApplication.missingProfileData ?? [],
