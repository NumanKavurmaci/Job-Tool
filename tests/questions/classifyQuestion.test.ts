...
describe("classifyQuestion", () => {
  it.each([
    ...
    [{ label: "Are you comfortable working remotely?", inputType: "radio" }, "remote_preference"],
    [{ label: "Do you require any reasonable accommodation?", inputType: "radio" }, "accessibility"],
