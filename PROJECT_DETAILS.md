...
3. Open the Easy Apply flow
4. Skip prefilled static fields when LinkedIn already has values
5. Fill deterministic and resume-derived answers where safe
6. Advance through `Next` and `Review`
7. Stop before final submit
